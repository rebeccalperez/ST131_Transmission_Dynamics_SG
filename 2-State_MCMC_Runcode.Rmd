...
##Run MCMC for all participants in the study 
```{r, echo = FALSE}
...
TS2.indiv.model1 <- rstan::stan(file="Two_State_MCMC_T10.stan", data=TS.data, iter=20000, chains = 3, cores=6, control=list(adapt_delta=0.95))
...
PERS2.indiv.model1 <- rstan::stan(file="Two_State_MCMC_T5.stan", data=TS.dataPERS2, iter=20000, chains = 3, cores=6, control=list(adapt_delta=0.95))
...
CORES2.indiv.model1 <- rstan::stan(file="Two_State_MCMC_T5.stan", data=TS.dataCORES2, iter=20000, chains = 3, cores=6, control=list(adapt_delta=0.95))
...
NONCORES2.indiv.model1 <- rstan::stan(file="Two_State_MCMC_T10.stan", data=NONCORES2.data, iter=20000, chains = 3, cores=6, control=list(adapt_delta=0.95))
